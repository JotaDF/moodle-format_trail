...
$string['defaultimagecontaineralignment'] = 'Alinhamento padrão dos containeres de imagem';
...
$string['defaultsectiontitlefontsize'] = 'amanho da fonte do título da seção';
...
$string['resetallimagecontainersize_help'] = 'Redefine os tamanhos dos containeres de imagens para o valor padrão de todos os cursos, de modo que seja o mesmo de um curso na primeira vez que estiver no formato de trilha.';
